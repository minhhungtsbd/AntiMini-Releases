...
1. Tải file [setup-sync-server.ps1](./setup-sync-server.ps1) về máy chủ của bạn.
2. Mở PowerShell với quyền Administrator và chạy lệnh:
   ```powershell
...
### Trên Linux (Bash)
1. Tải file [setup-sync-server.sh](./setup-sync-server.sh) về máy chủ.
